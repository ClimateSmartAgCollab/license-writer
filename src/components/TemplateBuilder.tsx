            ...
            <div className="mt-3 border border-emerald-300 bg-emerald-50 rounded-md p-3 flex items-start justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-emerald-800 mt-1">
                  Example: if this is collaborator information, add every collaborator entry here.
                  The attribute list now shows only this section's sub-fields.
                </p>
              </div>
              <button
        ...
        {isRepeatModalOpen && (
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center p-4 z-10">
            <div className="w-full max-w-lg bg-white rounded-lg shadow-lg border border-gray-200 p-5">
              <h3 className="text-lg font-semibold text-gray-900">Create repeating section</h3>
              <p className="text-sm text-gray-600 mt-2">
                Repeat for which attribute?
              </p>
              <p className="text-xs text-gray-500 mt-1">
                Pick a list attribute. This means the section repeats once per item in that list.
              </p>
